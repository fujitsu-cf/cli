...
import (
	...
	. "github.com/fujitsu-cf/cli/plugin_examples/test_rpc_server_example"

	"github.com/fujitsu-cf/cli/testhelpers/rpc_server"
	fake_rpc_handlers "github.com/fujitsu-cf/cli/testhelpers/rpc_server/fakes"
