...
import (
	...
	"github.com/fujitsu-cf/cli/cf/api/app_events"
	api_app_files "github.com/fujitsu-cf/cli/cf/api/app_files"
	"github.com/fujitsu-cf/cli/cf/api/app_instances"
	"github.com/fujitsu-cf/cli/cf/api/application_bits"
	applications "github.com/fujitsu-cf/cli/cf/api/applications"
	"github.com/fujitsu-cf/cli/cf/api/authentication"
	"github.com/fujitsu-cf/cli/cf/api/copy_application_source"
	"github.com/fujitsu-cf/cli/cf/api/environment_variable_groups"
	"github.com/fujitsu-cf/cli/cf/api/feature_flags"
	...
	"github.com/fujitsu-cf/cli/cf/api/security_groups/defaults/running"
	"github.com/fujitsu-cf/cli/cf/api/security_groups/defaults/staging"
	securitygroupspaces "github.com/fujitsu-cf/cli/cf/api/security_groups/spaces"
	"github.com/fujitsu-cf/cli/cf/api/space_quotas"
	"github.com/fujitsu-cf/cli/cf/api/spaces"
	stacks "github.com/fujitsu-cf/cli/cf/api/stacks"
