...
import (
	...
	"github.com/fujitsu-cf/cli/cf/actors/plugin_repo/fakes"
	"github.com/fujitsu-cf/cli/cf/command_registry"
	registryCmdFakes "github.com/fujitsu-cf/cli/cf/command_registry/fakes"
	"github.com/fujitsu-cf/cli/cf/configuration/core_config"
	"github.com/fujitsu-cf/cli/cf/configuration/plugin_config"
	testPluginConfig "github.com/fujitsu-cf/cli/cf/configuration/plugin_config/fakes"
	...
	testChecksum "github.com/fujitsu-cf/cli/utils/fakes"
