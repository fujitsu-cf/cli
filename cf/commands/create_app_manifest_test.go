...
import (
	...
	testAppInstanaces "github.com/fujitsu-cf/cli/cf/api/app_instances/fakes"
	...
	testManifest "github.com/fujitsu-cf/cli/cf/manifest/fakes"
	...
	testtime "github.com/fujitsu-cf/cli/testhelpers/time"
